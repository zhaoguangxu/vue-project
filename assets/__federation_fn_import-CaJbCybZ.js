...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-DfDSfpvY.js', import.meta.url).href),import:true},'vue-router':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-router-CrP7sEgj.js', import.meta.url).href),import:true},'pinia':{get:()=>()=>__federation_import(new URL('__federation_shared_pinia-l6Pk_WVL.js', import.meta.url).href),import:true}};
