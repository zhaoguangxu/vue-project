const currentImports = {};
      ...
      let moduleMap = {
"./Button":()=>{
      dynamicLoadingCss(["style-CCZSfru5.css"], false, './Button');
...
"./utils":()=>{
      dynamicLoadingCss(["style-CCZSfru5.css"], false, './utils');
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__vue-project__' + exposeItemName;
